<header>
  ...
  <nav class="header-superior">
    ...
    <a class="link-logo-mobile" href="/"><h2>Siempre Market</h2> </a>
    <!-- <img class="logo-mobile" src="/images/logo-blanco.png"> -->
    ...
    <p>¿Nuevo en Siempre Market? Mira las <a href="/faq">preguntas frecuentes</a></p>
