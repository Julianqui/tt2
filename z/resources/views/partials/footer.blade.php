<footer>
  ...
  <div class="franja-superior">
    ...
    <div class="footer-superior">
      ...
      <div class="footer-ubicación">
        <h3>¿Dónde estamos?</h3>
        <p>Av. Siempreviva, 742 (C1234)</p>
      ...
      <div class="footer-contacto">
        <h3>Entra en contacto</h3>
        <p>info@siempremarket.com</p>
        <p>(+54 11) 5555-5555</p>
      </div>
  ...
  <div class="franja-inferior">
    ...
    <div class="footer-inferior">
      ...
      <div class="footer-copyright">
        <h6>Copyright © 2018 Siempre Market</h6>
      </div>

      <div class="footer-creditos">
        <h6>Sitio desarrollado por <a href="#">Julian Quinteiro</a></h6>
      </div>
