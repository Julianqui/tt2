  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" >
      <div class="carousel-item active">
        <img class="d-block w-100" src="/images/hamster.jpg" alt="First slide">
        <div class="carousel-caption d-none d-md-block">
            <h2>El <strong>Raton Fugaz</strong></h2>
            <h2>Ya disponible en tu siempre es Market Ya disponible!</h2>
        </div>
      </div>
      <div class="carousel-item">
        <img class="d-block w-100" src="/images/perro.jpeg" alt="Second slide">
        <div class="carousel-caption d-none d-md-block">
      ...
      <div class="carousel-item">
        <img class="d-block w-100" src="/images/gato.jpeg" alt="Third slide">
        <div class="carousel-caption d-none d-md-block">
